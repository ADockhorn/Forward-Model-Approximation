...
public class CompetitionParameters
{
     ...
     */
    public static final int ACTION_TIME = 40; //original value = 40

    /**
     * Milliseconds for controller disqualification, if it returns an action after this time.
     */
    public static int ACTION_TIME_DISQ = 50; //original value = 50
    ...
    public static final int TOTAL_LEARNING_TIME = 2*MILLIS_IN_MIN; //10*MILLIS_IN_MIN
